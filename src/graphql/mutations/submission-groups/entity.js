...
const addSubmission = async (args, { db }) => db.collection('submission-group-submissions').insertOne(args);

const removeSubmission = async (args, { db }) => db.collection('submission-group-submissions').deleteOne(args);
